...
*/
Vue.component("simple_footer_component_1721883781", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            BookMart - Your Online Bookstore
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Discover your next great read at BookMart. We offer a vast selection of books across genres at unbeatable prices. Shop now and enjoy reading!
                    </div>
                </div>
            </div>
        </footer> 
